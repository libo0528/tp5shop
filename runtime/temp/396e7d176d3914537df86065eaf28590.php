<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\wamp\www\tpshop\public/../application/home\view\order\create.html";i:1542096400;s:52:"D:\wamp\www\tpshop\application\home\view\layout.html";i:1542075551;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
...
<!--各自页面的中间部分-->
	...
	<div class="cart py-container">
				...
				<div class="step-cont">
					<div class="addressInfo">
						<ul class="addr-detail">
							...
							<?php else: foreach($address as $k=>$v): ?>
							<li class="addr-item" address_id="<?php echo $v['id']; ?>">
								<div class="con name <?php if(($k==0)): ?>selected<?php endif; ?>"><a href="javascript:;" ><em>
									<?php echo $v['consignee']; ?></em><span title="点击取消选择">&nbsp;</span></a></div>
				...
				<div class="payshipInfo">
					...
					<div class="step-cont">
						<ul class="payType">
							...
							<li class="<?php if(($k=='alipay')): ?>selected<?php endif; ?>" pay_type="<?php echo $k; ?>"><?php echo $v; ?><span title="点击取消选择"></span></li>
							<?php endforeach; ?>
						</ul>
					</div>
					<div class="hr"></div>
		...
		<div class="clearfix trade">
			...
			<div class="fc-receiverInfo">寄送至:<?php echo $address!=[]?$address[0]['address']:''; ?> 收货人：<?php echo $address!=[]?$address[0]['consignee']:''; ?> <?php echo $address!=[]?$address[0]['phone']:''; ?></div>
		</div>
		<div class="submit">
			<a class="sui-btn btn-danger btn-xlarge" href="javascript:;">提交订单</a>
		</div>
	</div>
	<form action="<?php echo url('save'); ?>" method="post" id="orderForm">
		<input type="hidden" name="cart_ids" value="<?php echo \think\Request::instance()->param('cart_ids'); ?>">
	...
	<script type="text/javascript">
		$(function () {
			...
			$('.btn-primary').click(function () {
			    ...
			    //console.log(data);
			    $.ajax({
                    'url':"<?php echo url('home/address/create'); ?>",
                    'type':'post',
                    'data':data,
                    'dataType':'json',
			...
			$('.delete_address').click(function () {
                ...
                var that=this;
                $.ajax({
                    'url':"<?php echo url('home/address/delete'); ?>",
                    'type':'post',
                    'data':data,
                    'dataType':'json',
                    'success':function(res){
