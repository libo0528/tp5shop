<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\wamp\www\tpshop\public/../application/admin\view\goods\recyle.html";i:1541318539;s:53:"D:\wamp\www\tpshop\application\admin\view\layout.html";i:1541416893;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<!-- 右 -->
    <div class="content">
        <div class="header">
            <h1 class="page-title">商品回收站列表</h1>
        </div>

        <div class="well">
            <!-- search button -->
            <form action="<?php echo url('searchrecyle'); ?>" method="get" class="form-search">
                <div class="row-fluid" style="text-align: left;">
                    <div class="pull-left span4 unstyled">
                        <p> 商品名称：<input class="input-medium" name="keyword" type="text"
                        value="<?php echo \think\Request::instance()->get('keyword'); ?>"></p>
                    </div>
                </div>
                <button type="submit" class="btn">查找</button>
                <a class="btn btn-primary" href="<?php echo url('admin/goods/clearall'); ?>">清空回收站</a>
                <a class="btn btn-primary" href="<?php echo url('admin/goods/resetall'); ?>">全部还原</a>
            ...
            <table class="table table-bordered table-hover table-condensed">
                ...
                <?php foreach($list as $v): ?>
                    <tr class="info">
                        ...
                        <td><?php echo date('Y-m-d H:i:s',$v['delete_time']); ?></td>
                        <td>
                            <a href="<?php echo url('admin/goods/reset',['id'=>$v['id']]); ?>"> 还原 </a>
                            <a href="javascript:void(0);" onclick="if(confirm('彻底删除？'))
                                location.href='<?php echo url('admin/goods/clear',['id'=>$v['id']]); ?>'">彻底删除 </a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
