<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\wamp\www\tpshop\public/../application/admin\view\attribute\index.html";i:1541574043;s:53:"D:\wamp\www\tpshop\application\admin\view\layout.html";i:1541416893;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="sidebar-nav">
    ...
    <div class="content">
        ...
        <div class="well">
        <a class="btn btn-primary" href="<?php echo url('admin/attribute/create'); ?>">新增</a>
            <!-- table -->
                    ...
                    <tr class="success">
                        ...
                        <td>
                            ...
                            <a href="javascript:void(0);" onclick="if(confirm('确认删除？'))
                                location.href='<?php echo url('delete',['id'=>$v['id']]); ?>'"> 删除 </a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
