<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\wamp\www\tpshop\public/../application/admin\view\user\index.html";i:1540982815;s:53:"D:\wamp\www\tpshop\application\admin\view\layout.html";i:1541416893;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="content">
    ...
    <div class="well">
        <!-- search button -->
        <form action="<?php echo url('create'); ?>" method="get" class="form-search">
            <div class="row-fluid" style="text-align: left;">
                <div class="pull-left span4 unstyled">
                    <p> 会员名：<input class="input-medium" name="" type="text"></p>
                </div>
            </div>
            <button type="submit" class="btn">查找</button>
            <a class="btn btn-primary" href="<?php echo url('admin/user/create'); ?>">新增</a>
        </form>
    </div>
    <div class="well">
        <!-- table -->
        <table class="table table-bordered table-hover table-condensed">
            ...
            <tbody>
                <tr class="success">
                    ...
                    <td>
                        <a href="<?php echo url('admin/user/edit'); ?>"> 编辑 </a>
