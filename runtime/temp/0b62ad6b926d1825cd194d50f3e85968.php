<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\wamp\www\tpshop\public/../application/admin\view\manager\index.html";i:1541419999;s:53:"D:\wamp\www\tpshop\application\admin\view\layout.html";i:1541416893;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <table class="table table-bordered table-hover table-condensed">
            ...
            <?php foreach($list as $v): ?>
                <tr class="success">
                    ...
                    <?php endif; ?>
                    <td>
                        <?php if(($v['status']==1)): ?>可用<?php else: ?>不可用<?php endif; ?>
                    </td>
                    ...
                    <td>
                        ...
                        <a href="javascript:void(0);" onclick="if(confirm('确认删除？'))
                            location.href='<?php echo url('admin/manager/delete',['id'=>$v['id']]); ?>'"> 删除 </a>
                        <a href="<?php echo url('admin/manager/reset',['id'=>$v['id']]); ?>'"> 重置密码 </a>
                        <?php endif; ?>
                    </td>
                </tr>
            <?php endforeach; ?>
