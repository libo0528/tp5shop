<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\wamp\www\tpshop\public/../application/admin\view\goods\index.html";i:1540986894;s:53:"D:\wamp\www\tpshop\application\admin\view\layout.html";i:1541416893;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                    ...
                    <tr class="info">
                        ...
                        <td>
                            ...
                            <a href="javascript:void(0);" onclick="if(confirm('确认删除？'))
                                location.href='<?php echo url('admin/goods/delete',['id'=>$v['id']]); ?>'"> 删除 </a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
