<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\wamp\www\tpshop\public/../application/home\view\login\login.html";i:1542007386;}*/ ?>
<!DOCTYPE html>
...
<head>
	...
	<!--引入微博JS-->
	<script src="http://tjs.sjs.sinajs.cn/open/api/js/wb.js?appkey=3792754249&debug=true" type="text/javascript" charset="utf-8"></script>
</head>
	...
	<div class="login-box">
		...
		<div class="loginArea">
				...
				<div class="loginform">
					...
					<div class="tab-content tab-wraped">
						...
						<div id="profile" class="tab-pane  active">
							<form class="sui-form" method="post" action="<?php echo url('dologin'); ?>">
          ...
          自动登录
								...
								<div class="logined">
									<a class="sui-btn btn-block btn-xlarge btn-danger" href="javascript:;" target="_blank">登&nbsp;&nbsp;录</a>
								</div>
							</form>
							<div class="otherlogin">
								<div class="types">
									<ul>
										...
										<li><a href="/plugins/weibo/index.php"><img src="/static/home/img/sina.png" /></a></li>
