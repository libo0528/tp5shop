<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\wamp\www\tpshop\public/../application/admin\view\login\login.html";i:1540904615;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="login-main">
			<form action="<?php echo \think\Request::instance()->url(); ?>" class="form" method="post">
                ...
                <div class="form-item verify">
                    ...
                    <img class="pull-right" src="<?php echo captcha_src(); ?>"
                         onclick="this.src='<?php echo captcha_src(); ?>'+'?_='+Math.random()">
                    <div class="clear"></div>
                </div>
				<div class="form-item">
